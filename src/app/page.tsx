          ...
          <div className="text-center xl:text-left lg:text-left order-2 xl:order-none lg:order-none">
            ...
            <div className="flex flex-col xl:flex-row lg:flex-row items-center gap-8">
              ...
              <div className="mb-8 xl:mb-0 lg:mb-0">
                <Social containerStyles="flex gap-6" iconStyles="w-9 h-9 border border-accent rounded-full flex justify-center items-center text-accent texte-base hover:bg-accent hover:text-primary hover:transition-all duration-500" />
              </div>
            </div>
          </div>
